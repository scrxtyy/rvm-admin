...
class RVMController extends Controller
{
    ...
    public function show($id)
    {
        ...
        $totalplastic= monitorPlastics::where('rvm_id',$rvms->rvm_id)->latest()->first();
        //$totalplastic = $selecttotal->total_kg;
        
        $totaltincans= monitorTincans::where('rvm_id',$rvms->rvm_id)->latest()->first();
        //$totaltincans = $selecttotal1->total_kg;

        $currentCoins = monitorCoins::where('rvm_id',$rvms->rvm_id)->latest()->first(); 
