...
'class' => $withiconClasses . 'py-2 border-gray-400 text-gray-700 rounded-md focus:text-gray-700 focus:border-gray-400 focus:ring
focus:ring-green-500 focus:ring-offset-2 focus:ring-offset-white dark:border-gray-600 dark:bg-dark-eval-1
dark:text-gray-200 dark:focus:ring-offset-dark-eval-1',
])
!!}>
